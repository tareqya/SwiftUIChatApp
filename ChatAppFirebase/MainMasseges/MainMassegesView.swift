        ...
        self.listner = FirebaseManager.shared.firestore
            ...
            .addSnapshotListener { querySnapshot, error in
                ...
                querySnapshot?.documentChanges.forEach({change in
                    ...
                    self.recentMessages.insert(.init(document: documentId, data: data), at: 0)
                })
            }
    }
                        ...
                        self.shouldNavigateToChatLogView.toggle()
                            ...
                            HStack(spacing: 16) {
                                WebImage(url: URL(string: recentMessage.profileImageUrl))
                                    ...
                                    .clipped()
                                    .cornerRadius(25)
                                    .overlay(RoundedRectangle(cornerRadius: 64).stroke(.black, lineWidth: 1))
...
struct MainMassegesView_Previews: PreviewProvider {
